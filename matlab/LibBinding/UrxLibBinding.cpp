...
#define URX_OBJECT_IMPL(name)                                               \
  ...
  void CONCAT(name, delete)(void *this_ptr) { delete (urx::name*)this_ptr; }

#define URX_OBJECT_ACCESSOR_IMPL(name, member)                              \
  void* CONCAT(name, member)(void *this_ptr) { return &((urx::name*)this_ptr)->member; }
