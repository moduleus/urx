...
template <typename T>
struct MxLogicalTy<
    T, typename std::enable_if<std::is_same<typename std::remove_cv<T>::type, bool>::value ||
...
struct MxIntTy<
    T, typename std::enable_if<
           std::is_integral<T>::value && !MxLogicalTy<T>::value && !MxCharTy<T>::value, T>::type>
    : std::true_type {};
...
struct MxArithmeticTy<
    T, typename std::enable_if<(std::is_floating_point<T>::value) || (MxIntTy<T>::value), T>::type>
    : std::true_type {};
...
typedef struct mxNumeric_tag {
} mxNumeric;
typedef struct mxCell_tag {
} mxCell;
typedef struct mxComplex_tag {
} mxComplex;
...
struct MxTypes<T, typename std::enable_if<
                      std::is_signed<T>::value && MxIntTy<T>::value && sizeof(T) == 1, T>::type> {
  typedef T type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_unsigned<T>::value && MxIntTy<T>::value && sizeof(T) == 1, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_signed<T>::value && MxIntTy<T>::value && sizeof(T) == 2, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_unsigned<T>::value && MxIntTy<T>::value && sizeof(T) == 2, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_signed<T>::value && MxIntTy<T>::value && sizeof(T) == 4, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_unsigned<T>::value && MxIntTy<T>::value && sizeof(T) == 4, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_signed<T>::value && MxIntTy<T>::value && sizeof(T) == 8, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<T, typename std::enable_if<
                      std::is_unsigned<T>::value && MxIntTy<T>::value && sizeof(T) == 8, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<
    T, typename std::enable_if<std::is_floating_point<T>::value && sizeof(T) == 4, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
template <typename T>
struct MxTypes<
    T, typename std::enable_if<std::is_floating_point<T>::value && sizeof(T) == 8, T>::type> {
  typedef T type;
  typedef mxNumeric array_type;
...
struct MxTypes<
    T, typename std::enable_if<
           std::is_same<typename std::remove_cv<T>::type, std::complex<float>>::value, T>::type> {
  typedef T type;
...
struct MxTypes<
    T, typename std::enable_if<
           std::is_same<typename std::remove_cv<T>::type, std::complex<double>>::value, T>::type> {
  typedef T type;
  typedef mxComplex array_type;
  static const mxClassID class_id = mxDOUBLE_CLASS;
  static const mxComplexity complexity = mxCOMPLEX;
...
struct MxLogicalType<
    T, typename std::enable_if<std::is_same<typename MxTypes<T>::array_type, mxLogical>::value,
                               T>::type> : std::true_type {};
...
struct MxCharType<T, typename std::enable_if<
                         std::is_same<typename MxTypes<T>::array_type, mxChar>::value, T>::type>
    : std::true_type {};
...
struct MxArithmeticType<
    T, typename std::enable_if<std::is_same<typename MxTypes<T>::array_type, mxNumeric>::value,
                               T>::type> : std::true_type {};
...
struct MxComplexType<
    T, typename std::enable_if<std::is_same<typename MxTypes<T>::array_type, mxComplex>::value,
                               T>::type> : std::true_type {};
...
struct MxCellType<T, typename std::enable_if<
                         std::is_same<typename MxTypes<T>::array_type, mxCell>::value, T>::type>
    : std::true_type {};
...
struct MxLogicalCompound<
    T, typename std::enable_if<MxLogicalType<typename T::value_type>::value, T>::type>
    : std::true_type {};
...
template <typename T>
struct MxCharCompound<T,
                      typename std::enable_if<MxCharType<typename T::value_type>::value, T>::type>
    : std::true_type {};
...
struct MxArithmeticCompound<
    ...
    typename std::enable_if<
        (MxArithmeticType<typename T::value_type>::value) && !(MxComplexType<T>::value), T>::type>
    : std::true_type {};
...
struct MxComplexCompound<
    T, typename std::enable_if<MxComplexType<typename T::value_type>::value, T>::type>
    : std::true_type {};
...
struct MxComplexOrArithmeticCompound<
    T,
    typename std::enable_if<MxComplexCompound<T>::value || MxArithmeticCompound<T>::value, T>::type>
    : std::true_type {};
...
template <typename T>
struct MxCellCompound<T,
                      typename std::enable_if<MxCellType<typename T::value_type>::value, T>::type>
    : std::true_type {};
