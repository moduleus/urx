...
#define MEXPLUS_CHECK_NOTNULL(pointer)                                                             \
  if (!(pointer))                                                                                  \
  mexErrMsgIdAndTxt("mexplus:error", "Null pointer exception: %s:%d:%s `" #pointer "`.", __FILE__, \
...
class MxArray {
 public:
  ...
  /** Move constructor.
   */
  MxArray(MxArray&& array) NOEXCEPT : array_(NULL), owner_(false) { *this = std::move(array); }
  /** Move assignment.
   */
   ...
   */
  explicit MxArray(const mxArray* array) : array_(const_cast<mxArray*>(array)), owner_(false) {}
   ...
   */
  virtual ~MxArray() {
    if (array_ && owner_) mxDestroyArray(array_);
  }
  /** Swap operation.
   */
   ...
   * @endcode
   */
  static mxArray* Struct(int nfields = 0, const char** fields = NULL, int rows = 1,
                         int columns = 1) {
  ...
  static void set(mxArray* array, const std::string& field, mxArray* value, mwIndex index = 0) {
    ...
    if (field_number < 0) {
      ...
      MEXPLUS_ASSERT(field_number >= 0, "Failed to create a field '%s'", field.c_str());
    }
  ...
  mxLogical* getLogicals() const {
    MEXPLUS_CHECK_NOTNULL(array_);
    MEXPLUS_ASSERT(isLogical(), "Expected a logical array but %s.", className().c_str());
    return mxGetLogicals(array_);
  }
  mxChar* getChars() const {
    MEXPLUS_CHECK_NOTNULL(array_);
    MEXPLUS_ASSERT(isChar(), "Expected a char array but %s.", className().c_str());
   ...
   */
  inline const std::string className() const { return std::string(mxGetClassName(array_)); }
  /** Number of elements in an array.
   */
  inline mwSize size() const { return static_cast<mwSize>(mxGetNumberOfElements(array_)); }
  /** Number of dimensions.
   */
  inline mwSize dimensionSize() const { return mxGetNumberOfDimensions(array_); }
  ...
  std::vector<std::string> fieldNames() const {
    ...
    for (int i = 0; i < fields.size(); ++i) fields[i] = fieldName(i);
    return fields;
  }
  ...
  mwIndex subscriptIndex(mwIndex row, mwIndex column) const {
    MEXPLUS_ASSERT(row < rows() && column < cols(), "Subscript is out of range.");
  ...
  inline bool isVector() const {
    return mxGetNumberOfDimensions(array_) == 2 && (mxGetM(array_) == 1 || mxGetN(array_) == 1);
  }
   ...
   */
  inline bool isClass(const char* name) const { return mxIsClass(array_, name); }
   ...
   */
  inline bool isLogicalScalarTrue() const { return mxIsLogicalScalarTrue(array_); }
 ...
 private:
  ...
  static mxArray* fromInternal(const typename std::enable_if<MxArithmeticCompound<Container>::value,
                                                             Container>::type& value);
  /** Container with complex numbers, i.e. vector<complex<double>>.
   */
  template <typename Container>
  static mxArray* fromInternal(
      const typename std::enable_if<MxComplexCompound<Container>::value, Container>::type& value);
  /** Char type */
  template <typename T>
  ...
  template <typename Container>
  static mxArray* fromInternal(
      const typename std::enable_if<(MxCharCompound<Container>::value) &&
  ...
  template <typename Container>
  static mxArray* fromInternal(
      const typename std::enable_if<MxLogicalCompound<Container>::value, Container>::type& value);
  /** Container with cell type content.
   */
  template <typename Container>
  static mxArray* fromInternal(
      const typename std::enable_if<MxCellCompound<Container>::value, Container>::type& value);
  ...
  static void toInternal(
      const mxArray* array,
      typename std::enable_if<MxArithmeticType<T>::value || MxComplexType<T>::value ||
  ...
  static void toInternal(
      ...
      typename std::enable_if<MxComplexOrArithmeticCompound<T>::value ||
                                  MxLogicalCompound<T>::value || MxCharCompound<T>::value,
                              T>::type* value);
  ...
  static void toInternal(
      const mxArray* array,
      typename std::enable_if<MxCellType<T>::value && (!std::is_compound<T>::value ||
   ...
   */
  template <typename T>
  static void atInternal(
      const mxArray* array, mwIndex index,
      typename std::enable_if<MxComplexOrArithmeticType<T>::value || MxLogicalType<T>::value ||
                                  MxCharType<T>::value,
                              T>::type* value);
  ...
  static void atInternal(
      const mxArray* array, mwIndex index,
      typename std::enable_if<std::is_compound<T>::value && !MxComplexType<T>::value, T>::type*
          value);
  /** Structure access.
   */
  template <typename T>
  ...
  static void setInternal(
      ...
      const typename std::enable_if<!std::is_compound<T>::value || MxComplexType<T>::value,
                                    T>::type& value);
  /** Container types.
   */
  template <typename T>
...
#pragma warning(disable : 4244)
  ...
  static void assignTo(const mxArray* array, mwIndex index,
    ...
    if (mxIsComplex(array)) {
      ...
      T imag_part = *(reinterpret_cast<T*>(mxGetComplexDoubles(array)) + index);
...
#pragma warning(pop)
  ...
  static void assignTo(const mxArray* array, mwIndex index,
    ...
    if (mxIsComplex(array)) {
      ...
      imag_part = *(reinterpret_cast<T*>(mxGetComplexDoubles(array)) + index);
    } else {
  ...
  static void assignCharTo(const mxArray* array, mwIndex index,
    ...
    *value = static_cast<R>(*(reinterpret_cast<SignedMxChar*>(mxGetChars(array)) + index));
  }
...
#pragma warning(disable : 4244 4800)
  ...
  static void assignTo(
      const mxArray* array,
      typename std::enable_if<MxArithmeticCompound<R>::value || MxLogicalCompound<R>::value ||
    ...
    if (!mxIsComplex(array)) {
      ...
      T* imag_part = reinterpret_cast<T*>(mxGetComplexDoubles(array));
      value->resize(array_size);
      for (mwSize i = 0; i < array_size; ++i) {
        double mag = std::abs(std::complex<double>(static_cast<double>(*(real_part++)),
...
#pragma warning(pop)
  ...
  static void assignStringTo(
    ...
    typedef typename std::make_signed<mxChar>::type SignedMxChar;
    SignedMxChar* data_pointer = reinterpret_cast<SignedMxChar*>(mxGetChars(array));
...
#pragma warning(disable : 4244 4800)
  ...
  static void assignFrom(
      mxArray* array, mwIndex index,
      const typename std::enable_if<MxArithmeticType<T>::value || MxCharType<T>::value, T>::type&
          value) {
    if (mxIsComplex(array)) {
      *(reinterpret_cast<R*>(mxGetPr(array)) + index) = value;
      *(reinterpret_cast<R*>(mxGetComplexDoubles(array)) + index) = 0.0;
    } else {
...
#pragma warning(pop)
   ...
   */
  template <typename R, typename T>
  static void assignFrom(mxArray* array, mwIndex index,
                         const typename std::enable_if<MxComplexType<T>::value, T>::type& value) {
    if (mxIsComplex(array)) {
      *(reinterpret_cast<R*>(mxGetPr(array)) + index) = value.real();
      *(reinterpret_cast<R*>(mxGetComplexDoubles(array)) + index) = value.imag();
    } else {
...
#pragma warning(pop)
  ...
  static void assignCharFrom(
      mxArray* array, mwIndex index,
      const typename std::enable_if<std::is_integral<T>::value && std::is_signed<T>::value,
                                    T>::type& value) {
...
mxArray* MxArray::fromInternal(
    const typename std::enable_if<MxArithmeticType<T>::value, T>::type& value) {
  mxArray* array = mxCreateNumericMatrix(1, 1, MxTypes<T>::class_id, MxTypes<T>::complexity);
  MEXPLUS_CHECK_NOTNULL(array);
...
mxArray* MxArray::fromInternal(
  ...
  *reinterpret_cast<typename T::value_type*>(mxGetComplexDoubles(array)) = value.imag();
...
template <typename Container>
mxArray* MxArray::fromInternal(
    const typename std::enable_if<MxArithmeticCompound<Container>::value, Container>::type& value) {
  typedef typename Container::value_type ValueType;
  mxArray* array =
      mxCreateNumericMatrix(1, static_cast<int>(value.size()), MxTypes<ValueType>::class_id,
                            MxTypes<ValueType>::complexity);
  MEXPLUS_CHECK_NOTNULL(array);
  std::copy(value.begin(), value.end(), reinterpret_cast<ValueType*>(mxGetData(array)));
  return array;
}
...
mxArray* MxArray::fromInternal(
  ...
  ValueType* imag = reinterpret_cast<ValueType*>(mxGetComplexDoubles(array));
...
mxArray* MxArray::fromInternal(
    const typename std::enable_if<(MxCharCompound<Container>::value) &&
                                      (std::is_signed<typename Container::value_type>::value),
                                  Container>::type& value) {
  typedef typename std::make_unsigned<typename Container::value_type>::type UnsignedValue;
  ...
  for (typename Container::const_iterator it = value.begin(); it != value.end(); ++it) {
...
template <typename T>
void MxArray::atInternal(const mxArray* array, const std::string& field, mwIndex index, T* value) {
  MEXPLUS_CHECK_NOTNULL(array);
  MEXPLUS_CHECK_NOTNULL(value);
  MEXPLUS_ASSERT(static_cast<size_t>(index) < mxGetNumberOfElements(array),
                 "Index out of range: %u.", index);
...
void MxArray::setInternal(
    mxArray* array, mwIndex index,
    const typename std::enable_if<!std::is_compound<T>::value || MxComplexType<T>::value, T>::type&
        value) {
  MEXPLUS_CHECK_NOTNULL(array);
  MEXPLUS_ASSERT(static_cast<size_t>(index) < mxGetNumberOfElements(array),
                 "Index out of range: %u.", index);
 ...
 */
template <typename T>
void MxArray::setInternal(mxArray* array, mwIndex index,
                          const typename std::enable_if<MxCellType<T>::value, T>::type& value) {
  MEXPLUS_CHECK_NOTNULL(array);
  MEXPLUS_ASSERT(static_cast<size_t>(index) < mxGetNumberOfElements(array),
                 "Index out of range: %u.", index);
...
template <typename T>
void MxArray::setInternal(mxArray* array, const std::string& field, mwIndex index, const T& value) {
  MEXPLUS_CHECK_NOTNULL(array);
  MEXPLUS_ASSERT(static_cast<size_t>(index) < mxGetNumberOfElements(array),
                 "Index out of range: %u.", index);
  MEXPLUS_ASSERT(mxIsStruct(array), "Expected a struct array.");
...
mxArray* MxArray::Numeric(int rows, int columns) {
  typedef typename std::enable_if<MxComplexOrArithmeticType<T>::value, T>::type Scalar;
  mxArray* numeric =
      mxCreateNumericMatrix(rows, columns, MxTypes<Scalar>::class_id, MxTypes<Scalar>::complexity);
...
mxArray* MxArray::Numeric(std::vector<std::size_t> dims) {
  typedef typename std::enable_if<MxComplexOrArithmeticType<T>::value, T>::type Scalar;
  mxArray* numeric = mxCreateNumericArray(dims.size(), &dims[0], MxTypes<Scalar>::class_id,
...
T* MxArray::getData() const {
  MEXPLUS_CHECK_NOTNULL(array_);
  MEXPLUS_ASSERT(MxTypes<T>::class_id == classID(), "Expected a %s array.", typeid(T).name());
...
T* MxArray::getImagData() const {
  MEXPLUS_CHECK_NOTNULL(array_);
  MEXPLUS_ASSERT(MxTypes<T>::class_id == classID(), "Expected a %s array.", typeid(T).name());
  return reinterpret_cast<T*>(mxGetComplexDoubles(array_));
}
