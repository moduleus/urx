...
void RcaArray::printSelf(std::ostream& os, std::string indent) const {
  ...
  if (m_pitchX.has_value())
    os << indent + UFF_STD_INDENT << "PitchX: " << m_pitchX.value()
       << std::endl;
  else
    os << indent + UFF_STD_INDENT << "PitchX: " << UNDEFINED << std::endl;

  if (m_pitchY.has_value())
    os << indent + UFF_STD_INDENT << "PitchY: " << m_pitchY.value()
       << std::endl;
  else
    os << indent + UFF_STD_INDENT << "PitchY: " << UNDEFINED << std::endl;

  if (m_elementWidthX.has_value())
    os << indent + UFF_STD_INDENT
       << "ElementWidthX: " << m_elementWidthX.value() << std::endl;
  else
  ...
  if (m_elementHeightX.has_value())
    os << indent + UFF_STD_INDENT
       << "ElementHeightX: " << m_elementHeightX.value() << std::endl;
  else
  ...
  if (m_elementWidthY.has_value())
    os << indent + UFF_STD_INDENT
       << "ElementWidthY: " << m_elementWidthY.value() << std::endl;
  else
  ...
  if (m_elementHeightY.has_value())
    os << indent + UFF_STD_INDENT
       << "ElementHeightXY: " << m_elementHeightY.value() << std::endl;
  else
