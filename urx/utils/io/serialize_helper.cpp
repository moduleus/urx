    ...
    SerializeHelper::member_name{
        {typeid(urx::Acquisition),
         {MAP_ROW(urx::Acquisition, authors), MAP_ROW(urx::Acquisition, description),
          ...
          MAP_ROW(urx::Acquisition, excitations), MAP_ROW(urx::Acquisition, groups),
          MAP_ROW(urx::Acquisition, groups_data)}},
        {typeid(urx::Dataset),
         {MAP_ROW(urx::Dataset, acquisition), MAP_ROW(urx::Dataset, version)}},
        {typeid(urx::Element),
        ...
        {typeid(urx::Event),
         {MAP_ROW(urx::Event, transmit_setup), MAP_ROW(urx::Event, receive_setup)}},
        ...
        {typeid(urx::ImpulseResponse),
         {MAP_ROW(urx::ImpulseResponse, sampling_frequency),
          MAP_ROW(urx::ImpulseResponse, time_offset), MAP_ROW(urx::ImpulseResponse, units),
          MAP_ROW(urx::ImpulseResponse, data)}},
        {typeid(urx::Probe),
         {MAP_ROW(urx::Probe, description), MAP_ROW(urx::Probe, type),
          MAP_ROW(urx::Probe, transform), MAP_ROW(urx::Probe, element_geometries),
          MAP_ROW(urx::Probe, impulse_responses), MAP_ROW(urx::Probe, elements)}},
        {typeid(urx::ReceiveSetup),
         {MAP_ROW(urx::ReceiveSetup, probe), MAP_ROW(urx::ReceiveSetup, probe_transform),
          MAP_ROW(urx::ReceiveSetup, sampling_frequency),
          MAP_ROW(urx::ReceiveSetup, number_samples), MAP_ROW(urx::ReceiveSetup, active_elements),
          MAP_ROW(urx::ReceiveSetup, tgc_profile),
          MAP_ROW(urx::ReceiveSetup, tgc_sampling_frequency),
          MAP_ROW(urx::ReceiveSetup, modulation_frequency),
          MAP_ROW(urx::ReceiveSetup, time_offset)}},
        ...
        {typeid(urx::TransmitSetup),
         {MAP_ROW(urx::TransmitSetup, probe), MAP_ROW(urx::TransmitSetup, wave),
          MAP_ROW(urx::TransmitSetup, active_elements), MAP_ROW(urx::TransmitSetup, excitations),
          MAP_ROW(urx::TransmitSetup, delays), MAP_ROW(urx::TransmitSetup, probe_transform),
          MAP_ROW(urx::TransmitSetup, time_offset)}},
        {typeid(urx::Vector3D<double>),
         {MAP_ROW(urx::Vector3D<double>, x), MAP_ROW(urx::Vector3D<double>, y),
          MAP_ROW(urx::Vector3D<double>, z)}},
        {typeid(urx::Version),
         {MAP_ROW(urx::Version, major), MAP_ROW(urx::Version, minor),
          MAP_ROW(urx::Version, patch)}},
        {typeid(urx::Wave),
         {MAP_ROW(urx::Wave, type), MAP_ROW(urx::Wave, time_zero),
          MAP_ROW(urx::Wave, time_zero_reference_point), MAP_ROW(urx::Wave, parameters)}},
    };
