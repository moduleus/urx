...
@overload
def clone(arg0: UrxDoubleNan) -> UrxDoubleNan: ...
@overload
def clone(arg0: UrxVector2D) -> UrxVector2D: ...
@overload
def clone(arg0: UrxVector3D) -> UrxVector3D: ...
@overload
def clone(arg0: UrxVersion) -> UrxVersion: ...
@overload
def clone(arg0: UrxTransform) -> UrxTransform: ...
@overload
def clone(arg0: UrxWave) -> UrxWave: ...
@overload
def clone(arg0: UrxElement) -> UrxElement: ...
@overload
def clone(arg0: UrxElementGeometry) -> UrxElementGeometry: ...
@overload
def clone(arg0: UrxImpulseResponse) -> UrxImpulseResponse: ...
@overload
def clone(arg0: UrxTransmitSetup) -> UrxTransmitSetup: ...
@overload
def clone(arg0: UrxReceiveSetup) -> UrxReceiveSetup: ...
@overload
def clone(arg0: UrxEvent) -> UrxEvent: ...
@overload
def clone(arg0: UrxExcitation) -> UrxExcitation: ...
@overload
def clone(arg0: UrxGroup) -> UrxGroup: ...
@overload
def clone(arg0: UrxGroupData) -> UrxGroupData: ...
@overload
def clone(arg0: UrxProbe) -> UrxProbe: ...
@overload
def clone(arg0: UrxAcquisition) -> UrxAcquisition: ...
@overload
def clone(arg0: UrxDataset) -> UrxDataset: ...
